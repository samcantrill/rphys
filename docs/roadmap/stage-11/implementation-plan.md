...
| 8 | `api-validation-closeout` | merged | `agent/stage-11-loss-objective-metric-contracts-p8-api-validation-closeout` | [#78](https://github.com/samcantrill/rphys/pull/78) | package exports, docs/docstrings, import-boundary and final validation evidence | Closed public API, docs, import boundaries, and full-stage validation. | `make test-package`; `make test-unit`; `make test-contract`; `make test-integration`; `make test-summary`; `uv lock --check`; `git diff --check`; `make validate-pr` | Examples 1-8 |
...
- Phase execution plan: completed in `docs/roadmap/stage-11/phases/sample-collection-views.md`
- Planning/refinement budget: medium
- Implementation/refinement budget: medium
- PR review budget: medium
...
- Merge record: completed in `docs/roadmap/stage-11/phases/sample-collection-views-merge-record.md`
...
- Implementation: added sample collections, collectors, view plans, planned view execution, data exports, and fake/injected stitch behavior.
- Validation: focused sample collection/package tests; `UV_CACHE_DIR=/tmp/uv-cache make test-unit`; `UV_CACHE_DIR=/tmp/uv-cache make test-contract`; `UV_CACHE_DIR=/tmp/uv-cache make test-package`; `git diff --check`.
- PR: [#75](https://github.com/samcantrill/rphys/pull/75)
- Merge: squash merged to `develop` as `2ff5412` on 2026-05-16.
- Follow-up: Stage 13 owns evaluator runner policy and concrete reconstruction algorithms.
...
- Phase execution plan: completed in `docs/roadmap/stage-11/phases/metric-observation-views-composition.md`
- Planning/refinement budget: medium
- Implementation/refinement budget: medium
- PR review budget: medium
...
- Phase execution plan: completed in `docs/roadmap/stage-11/phases/api-validation-closeout.md`
- Planning/refinement budget: medium
...
- Merge record: completed in `docs/roadmap/stage-11/phases/api-validation-closeout-merge-record.md`
...
- PR: [#78](https://github.com/samcantrill/rphys/pull/78)
- Merge: squash merged to `develop` as `4c7eb00` on 2026-05-16.
- Follow-up: Stage 11 implementation is complete; later stages own scalar/backward/distributed adapters, evaluator/report/dataframe schemas, and concrete algorithm catalogs.
