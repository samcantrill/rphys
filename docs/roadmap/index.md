...
1. Refresh GitHub CLI authentication with `gh auth login -h github.com` before PR creation or merge for public architecture contracts.
2. Convert the completed local scaffold into the planned PR/merge flow, or explicitly accept a direct local commit strategy.
