...
PR title: `agent/Milestone 1 Naming, Locators, Schemas, Metadata, And Errors - Phase 1: Diagnostic And DataKey Foundation`
Base branch: `develop`
Target branch: `develop`
...
PR title: `agent/Milestone 1 Naming, Locators, Schemas, Metadata, And Errors - Phase 2: Metadata And Split Vocabularies`
Base branch: `develop`
Target branch: `develop`
Workflow path: fast path
...
PR title: `agent/Milestone 1 Naming, Locators, Schemas, Metadata, And Errors - Phase 3: Schema And Data Type Vocabularies`
Base branch: `develop`
Target branch: `develop`
Workflow path: fast path
...
PR title: `agent/Milestone 1 Naming, Locators, Schemas, Metadata, And Errors - Phase 4: Field Roles And Locators`
Base branch: `develop`
Target branch: `develop`
Workflow path: fast path
...
PR title: `agent/Milestone 1 Naming, Locators, Schemas, Metadata, And Errors - Phase 5: Contract, Package, And Documentation Hardening`
Base branch: `develop`
Target branch: `develop`
