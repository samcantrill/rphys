...
Status: approved for implementation; phase work has not started.
Roadmap version: `v15`
...
- Source plan quality gate: passed for initial implementation-plan drafting; expanded-scope review is recorded and pending maintainer approval.
