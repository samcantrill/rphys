...
This is the high-level draft pass for `docs/implementation/<roadmap-slug>/master-plan.md`. A later refinement prompt makes the same artifact decision-complete before the quality gate.
