...
4. Block implementation-plan drafting when behavior, design, examples, validation, or phase shaping would require an implementation agent to invent product or design decisions.
5. Record pass/block evidence in `Plan Quality Gate`.
6. Update only `docs/roadmap/stage-<N>/planning.md`.
