...
8. For each design decision, record what, why, proposed shape, impact, options, recommendation, pros/cons, limitation or trade-off, validation/documentation obligation, residual risk, status, and whether maintainer escalation is needed.
